...
/**
 * A custom panel that holds both the player's scrapyardGUI. The panel has a
 * image as background.
 * 
 * @author 13120dde
 *
...
public class ScrapyardPanel extends JPanel {
	...
	/**The constructor needs two instances of scrapyardGUI as parameters. One for each player.
	 * 
	 * @param playerScrapyard : ScrapyardGUI
	 * @param opponentScrapyard : ScrapyardGUI
	 */
